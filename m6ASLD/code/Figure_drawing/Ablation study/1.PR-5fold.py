...
counter0 = 0
fileName=['All','CGR_position','WAL','WGG','WSM','WSMA']
typein=0
while typein<len(fileName):
    print(fileName[typein])
    counter0 = 0
    while counter0 < 10:
        # print(i)
        # 读取文件
        ...
        RAPName = fileName[typein]+'/'+'Real_Predition'+str(counter0) + '.csv'
        RAPNameProb = fileName[typein]+'/'+'Real_Predition_prob'+str(counter0) + '.csv'
    ...
    while counter < len(mean_P):
        ...
        PAndR.append(pair)
        counter = counter + 1
    storFile(PAndR, fileName[typein]+'/'+'PAndR'+'.csv')
    print(fileName[typein])
